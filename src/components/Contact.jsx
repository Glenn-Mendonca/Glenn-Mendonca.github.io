  ...
  return (
    ...
    >
      <div className="md:flex block md:gap-x-5">
        <input
          className="flex-1 w-full mb-4 p-2 rounded bg-light-secondary dark:bg-[#444448] placeholder:text-dark-secondary dark:placeholder:text-light-secondary"
          placeholder="Name"
          type="text"
          name="name"
          required
      ...
      <textarea
        name="message"
        rows="7"
        className="w-full p-2 rounded-md bg-light-secondary dark:bg-[#444448] placeholder:text-dark-secondary dark:placeholder:text-light-secondary"
